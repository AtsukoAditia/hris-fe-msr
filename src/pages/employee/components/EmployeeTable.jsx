import { ContactRound, Edit2, Eye, FileText, Trash2, User } from 'lucide-react'
            ...
            <tr key={employee.id} className="transition-colors hover:bg-gray-50">
              ...
              <td className="px-6 py-4 text-right">
                <div className="flex items-center justify-end space-x-2">
                  ...
                  {canManageEmployee && <a href={`/employee/${employee.id}/documents`} className="p-2 text-gray-400 hover:text-violet-600" title="Dokumen"><FileText className="h-4 w-4" /></a>}
